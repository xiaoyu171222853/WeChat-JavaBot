...
public class DeepSeekChatService {
    ...
    public CompletableFuture<DSRespMessage> chat(String userId, String chatId, String content, DeepSeekModel deepSeekModel) {
        request.setDeepSeekModel(deepSeekModel);
        // 构建消息 更新仓库
        deepSeekUtil.preChat(userId,chatId,content);
